...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		txtTracklist.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		leftArrow = new FlxSprite(grpWeekText.members[0].x + grpWeekText.members[0].width - 400, grpWeekText.members[0].y - 400);
